                      ...
                      ,'<dl class="layui-anim layui-anim-upbit'+ (othis.find('optgroup')[0] ? ' layui-select-group' : '') +'">'+ function(options){
                          ...
                          layui.each(options, function(index, item){
                              if(index === 0 && !item.value){
                                  ...
                                  //mod by qian add pics combox
                                  //arr.push('<dd lay-value="' + item.value + '" class="' + (value === item.value ? THIS : '') + (item.disabled ? (' ' + DISABLED) : '') + '">' + item.innerHTML + '</dd>');
                                  var tmpstr = '<dd lay-value="' + item.value + '" class="' + (value === item.value ? THIS : '') + (item.disabled ? (' ' + DISABLED) : '') + '">';
                                  var pics = $(item).attr("pics");
                                  if (pics) {
                                      tmpstr += '<img src="' + eval(pics) + '" class="qui-select-pics">';
                                  }
                                  tmpstr += item.innerHTML + '</dd>';
                                  arr.push(tmpstr);
                              }
                          });
